/*
	...
	Date: 23/10/22 12:22
	Description: 6.33. (Palíndromos). Un palíndromo es una cadena que se escribe de la 
	misma forma hacia adelante y hacia atrás. Algunos ejemplos de palíndromos son "radar", 
	"able was i ere i saw elba", y "a man a plan a canal panama". Escriba una función 
	recursiva testPalindorme, que devuelva uno si la cadena almacenada en el arreglo es un 
	palíndromo y 0 de lo contrario. La función deberá ignorar espacios y puntuaciones 
